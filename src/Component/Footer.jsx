        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#rooms" className="hover:text-yellow-400 transition-colors">Rooms</a></li>
              <li><a href="#amenities" className="hover:text-yellow-400 transition-colors">Amenities</a></li>
              <li><a href="#location" className="hover:text-yellow-400 transition-colors">Location</a></li>
